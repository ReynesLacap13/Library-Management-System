...
namespace REREY.Pages
{
    public class IndexModel : PageModel
    {
        ...
        public void OnGet()
        {
            ...
            PhysicalBook physicalBook = new PhysicalBook("To Kill a Mockingbird", "Harper Lee", "9780061120084", 281);
            EBook eBook = new EBook("1984", "George Orwell", "9780451524935", 512);
